...
### 2.4 实验现象记录（设备端）
<p align="center">
  <img src="image-1.png" alt="设备端终端输出截图" width="700">
</p>
...
- 设备列表与实时数据页面截图：
<p align="center">
  <img src="1768654294152.png" alt="设备列表与实时数据页面截图" width="700">
</p>
- 灯光控制按钮执行结果截图：
<p align="center">
  <img src="6a251bef3b9174c787b86c04703051d5.jpg" alt="灯光控制按钮执行结果截图" width="700">
</p>
- 历史数据回放曲线截图：
<p align="center">
  <img src="1768654333339.png" alt="历史数据回放曲线截图" width="700">
</p>
- 服务端网页首页截图（运行 `python server.py` 后访问 `http://localhost:5000`）：
<p align="center">
  <img src="image.png" alt="服务端网页首页截图" width="700">
</p>
